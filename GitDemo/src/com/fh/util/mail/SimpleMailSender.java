  ...
  */    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("13668229365");    
	     mailInfo.setPassword("luo_153971");//您的邮箱密码    
	     mailInfo.setFromAddress("13668229365@163.com");    
	     mailInfo.setToAddress("743834043@qq.com");    
	     mailInfo.setSubject("测试邮件标题");    
